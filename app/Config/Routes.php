...
/* We get a performance increase by specifying the default
 ...
 $routes->match(['get', 'post'], 'Auth/loginAcc', 'Auth::loginAcc');
 $routes->get('salir', 'Auth::salir');

  $routes->group('panel', ['filter' => 'superadmin'], function ($routes) {

  $routes->get('/', 'Home::panel', ['filter' => 'superadmin']);
 // $routes->get('tiendas', 'Home::tiendas', ['filter' => 'superadmin']);
